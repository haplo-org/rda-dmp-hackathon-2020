...
P.implementService("hres:data_management_plans:update_dmp_for_project", function(project, dmp) {
    let dmpStore = P.dmpDocstore.instance(project);
    dmpStore.setCurrentDocument(dmp, true);
    dmpStore.commit(O.currentUser);
});
